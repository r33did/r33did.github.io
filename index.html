    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="assets/img/pfp.jpg" alt="..." />
                <!-- Masthead Heading-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Data Enthusiast - Data Science - Data Engineer</p>
            </div>
        </header>
        <!-- Portfolio Section-->
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/emg.png" alt="..." />
                        </div>
                    </div>
                    <!-- Portfolio Item 2-->
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal2">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/janken2.png" alt="..." />
                        </div>
                    </div>
                    <!-- Portfolio Item 3-->
                    <div class="col-md-6 col-lg-4 mb-5">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5 mb-md-0">
                        <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal5">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/gcp.jpg" alt="..." />
                        </div>
                    </div>
                    <!-- Portfolio Item 6-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto"><p class="lead">I'm fresh graduate with Bachelor Degree of Engineering. I'm passionate with data and eager to learn more knowledge !</p></div>
                    <div class="col-lg-4 me-auto"><p class="lead">You can download my CV and Resume here!</p></div>
                </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <img class="img-fluid rounded mb-5" src="assets/img/portfolio/emg.png" alt="..." />
                                    <!-- Portfolio Modal - Text-->
                                    <p class="mb-4">https://github.com/r33did/SkripsiEmosiRNN</p>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="assets/img/portfolio/janken2.png" alt="..." />
                                    <!-- Portfolio Modal - Text-->
                                    <p class="mb-4">https://github.com/r33did/Rock-paper-scissors-CNN</p>
                                    <button class="btn btn-primary" href="#!" data-bs-dismiss="modal">
                                        <i class="fas fa-times fa-fw"></i>
                                        Close Window
                                    </button>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Text-->
                                    <p class="mb-4">https://github.com/r33did/Databases-and-SQL-for-Data-Science_FinalAssignment</p>
                                    <button class="btn btn-primary" href="#!" data-bs-dismiss="modal">
                                        <i class="fas fa-times fa-fw"></i>
                                        Close Window
                                    </button>
